...
export const leaveFormMap: Record<LeaveFormType, DialogData> = {
  quitFeedback: {
    ...
    content: $localize`:@@Component.LeaveForm.QuitFeedbackContent:Si vous quittez la page, le feedZback que vous avez commencé à remplir sera perdu.`,
  ...
  applyFeedbackDraft: {
    ...
    content: $localize`:@@Component.LeaveForm.ApplyFeedbackDraftContent:Si vous appliquez le brouillon, le feedZback que vous avez commencé à remplir sera perdu.`,
